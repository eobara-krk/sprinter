...
static dzien0: string = `<div style="font-family: 'Segoe UI', Tahoma, sans-serif; font-size: 16px; color: #2e2e2e; background-color: #f4f6f9; padding: 40px; line-height: 1.6;">
